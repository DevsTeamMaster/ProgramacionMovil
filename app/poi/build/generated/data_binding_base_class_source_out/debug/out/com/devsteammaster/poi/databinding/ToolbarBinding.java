...
public final class ToolbarBinding implements ViewBinding {
  ...
  private ToolbarBinding(@NonNull Toolbar rootView, @NonNull Toolbar baseToolbar,
  ...
  public static ToolbarBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      Toolbar baseToolbar = (Toolbar) rootView;
      ...
      return new ToolbarBinding((Toolbar) rootView, baseToolbar, toolbarTitle);
    }
